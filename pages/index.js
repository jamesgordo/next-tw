    ...
    <div className="px-8">
      ...
      <main className="h-screen py-16 flex flex-col justify-center items-center">
        ...
        <div className="grid grid-cols-2 justify-center items-center flex-wrap max-w-[800px]">
          ...
          >
            <h2 className="m-0 text-xl leading-normal mb-4">Documentation &rarr;</h2>
            <p className="m-0">Find in-depth information about Next.js features and API.</p>
          </a>
          ...
          >
            ...
            <p className="m-0">Learn about Next.js in an interactive course with quizzes!</p>
          </a>
          ...
          >
            ...
            <p className="m-0">Discover and deploy boilerplate example Next.js projects.</p>
          </a>
          ...
          >
            ...
            <p className="m-0">Instantly deploy your Next.js site to a public URL with Vercel.</p>
          </a>
        </div>
      </main>
